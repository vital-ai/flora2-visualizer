/* File:      AddRegionToModuleAction.java
 **
 ...
 * 
 * Adds the selected Text of the current FloraEditor to a specified
 * module of the {@link FloraReasoner}
 */
public class AddRegionToModuleAction extends AbstractFloraEditorAction {
	...
	/**
	 * creates and returns a new {@link AddRegionToModuleAction}
	 * 
	 * @return a new <code>AddRegionToModuleAction<code>
	 * 
	...
	public AbstractFloraEditorAction createAction() {
		return new AddRegionToModuleAction();
	}
	 ...
	 * @see FloraReasoner#addString(String,String)
	...
	public void run() {
		if (fEditor != null) {
			...
			Job theJob = new Job("Adding Region to " + fModule) {
				protected IStatus run(IProgressMonitor monitor) {
				    Display.getDefault().asyncExec(new Runnable() {
					    public void run() {
						FloraReasoner.getInstance().addString(fRegion, fModule);
					    }
					});
